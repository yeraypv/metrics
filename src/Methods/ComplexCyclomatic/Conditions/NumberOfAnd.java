...
public final class NumberOfAnd implements Metric {

    private FilesUtils fileutil = new FilesUtils();
    private int num = 0;

    public NumberOfAnd(ReaderMethod readerfile) {
        count(readerfile);
    }

    private int getAnds(ReaderMethod readerfile) throws IOException {
